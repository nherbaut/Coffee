...
import hlvl.proxy.FunctionProxy;
 ...
 * </p>
 * <ul>
 *   <li>{@link hlvl.impl.FunctionImpl#getOp <em>Op</em>}</li>
 *   <li>{@link hlvl.impl.FunctionImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link hlvl.impl.FunctionImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
@XmlRootElement(name = "function")
@XmlSeeAlso({ FunctionProxy.class, Wrapper.class, RelationalImpl.class, RelationalImpl.class })
public class FunctionImpl extends RelationalImpl implements Function {
	...
	public NotificationChain basicSetLeft(Relational newLeft, NotificationChain msgs) {
		...
		left = newLeft;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HlvlPackage.FUNCTION__LEFT,
					oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - HlvlPackage.FUNCTION__LEFT, null, msgs);
			if (newLeft != null)
	...
	public NotificationChain basicSetRight(Relational newRight, NotificationChain msgs) {
		...
		right = newRight;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HlvlPackage.FUNCTION__RIGHT,
					oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - HlvlPackage.FUNCTION__RIGHT, null, msgs);
			if (newRight != null)
