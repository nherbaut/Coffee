...
import hlvl.proxy.MulOrDivProxy;
 ...
 * </p>
 * <ul>
 *   <li>{@link hlvl.impl.MulOrDivImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link hlvl.impl.MulOrDivImpl#getOp <em>Op</em>}</li>
 *   <li>{@link hlvl.impl.MulOrDivImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
@XmlRootElement(name = "mulordiv")
@XmlSeeAlso({ MulOrDivProxy.class, Wrapper.class, RelationalImpl.class, RelationalImpl.class })
public class MulOrDivImpl extends RelationalImpl implements MulOrDiv {
	...
	public NotificationChain basicSetLeft(Relational newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HlvlPackage.MUL_OR_DIV__LEFT,
					oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - HlvlPackage.MUL_OR_DIV__LEFT, null, msgs);
			if (newLeft != null)
	...
	public NotificationChain basicSetRight(Relational newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlvlPackage.MUL_OR_DIV__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - HlvlPackage.MUL_OR_DIV__RIGHT, null, msgs);
			if (newRight != null)
