...
import hlvl.proxy.ValuationProxy;
 ...
 * </p>
 * <ul>
 *   <li>{@link hlvl.impl.ValuationImpl#getElement <em>Element</em>}</li>
 *   <li>{@link hlvl.impl.ValuationImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
@XmlRootElement(name = "valuation")
@XmlSeeAlso({ ValuationProxy.class, Wrapper.class, ElmDeclarationImpl.class, ValueImpl.class })
public class ValuationImpl extends EObjectImpl implements Valuation {
		...
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HlvlPackage.VALUATION__ELEMENT,
							oldElement, element));
			}
		}
		return element;
	...
	public NotificationChain basicSetValue(Value newValue, NotificationChain msgs) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HlvlPackage.VALUATION__VALUE,
					oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - HlvlPackage.VALUATION__VALUE, null, msgs);
			if (newValue != null)
