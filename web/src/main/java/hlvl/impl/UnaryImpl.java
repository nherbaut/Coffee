 ...
 * </p>
 * <ul>
 *   <li>{@link hlvl.impl.UnaryImpl#getOp <em>Op</em>}</li>
 *   <li>{@link hlvl.impl.UnaryImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
@XmlRootElement(name = "unary")
@XmlSeeAlso({ UnaryProxy.class, Wrapper.class, RelationalImpl.class })
	...
	public NotificationChain basicSetExpression(Relational newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlvlPackage.UNARY__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - HlvlPackage.UNARY__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, HlvlPackage.UNARY__EXPRESSION, newExpression,
					newExpression));
	}
