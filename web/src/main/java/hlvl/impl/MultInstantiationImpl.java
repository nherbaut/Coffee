...
import hlvl.proxy.MultInstantiationProxy;
import hlvl.proxy.NumberAdapter;
 ...
 * </p>
 * <ul>
 *   <li>{@link hlvl.impl.MultInstantiationImpl#getName <em>Name</em>}</li>
 *   <li>{@link hlvl.impl.MultInstantiationImpl#getMin <em>Min</em>}</li>
 *   <li>{@link hlvl.impl.MultInstantiationImpl#getMax <em>Max</em>}</li>
 * </ul>
 *
 * @generated
 */
@XmlRootElement(name = "multinstantiation")
@XmlSeeAlso({ MultInstantiationProxy.class, Wrapper.class, ElmDeclarationImpl.class, NumberImpl.class,
		NumberImpl.class })
public class MultInstantiationImpl extends RelationImpl implements MultInstantiation {
		...
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HlvlPackage.MULT_INSTANTIATION__NAME,
							oldName, name));
			}
		}
		return name;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMin(hlvl.Number newMin, NotificationChain msgs) {
		hlvl.Number oldMin = min;
		min = newMin;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlvlPackage.MULT_INSTANTIATION__MIN, oldMin, newMin);
			if (msgs == null)
				msgs = notification;
			else
	 ...
	 * @generated
	 */
	public void setMin(hlvl.Number newMin) {
		if (newMin != min) {
			NotificationChain msgs = null;
			if (min != null)
				msgs = ((InternalEObject) min).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - HlvlPackage.MULT_INSTANTIATION__MIN, null, msgs);
			if (newMin != null)
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMax(hlvl.Number newMax, NotificationChain msgs) {
		hlvl.Number oldMax = max;
		max = newMax;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					HlvlPackage.MULT_INSTANTIATION__MAX, oldMax, newMax);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	 ...
	 * @generated
	 */
	public void setMax(hlvl.Number newMax) {
		if (newMax != max) {
			NotificationChain msgs = null;
			if (max != null)
				msgs = ((InternalEObject) max).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - HlvlPackage.MULT_INSTANTIATION__MAX, null, msgs);
			if (newMax != null)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case HlvlPackage.MULT_INSTANTIATION__NAME:
			...
			return;
		case HlvlPackage.MULT_INSTANTIATION__MIN:
			setMin((hlvl.Number) newValue);
			return;
		case HlvlPackage.MULT_INSTANTIATION__MAX:
			setMax((hlvl.Number) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case HlvlPackage.MULT_INSTANTIATION__NAME:
			...
			return;
		case HlvlPackage.MULT_INSTANTIATION__MIN:
			setMin((hlvl.Number) null);
			return;
		case HlvlPackage.MULT_INSTANTIATION__MAX:
			setMax((hlvl.Number) null);
			return;
		}
