...
import hlvl.proxy.VarListProxy;
 ...
 * </p>
 * <ul>
 *   <li>{@link hlvl.impl.VarListImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link hlvl.impl.VarListImpl#getVar1 <em>Var1</em>}</li>
 *   <li>{@link hlvl.impl.VarListImpl#getList <em>List</em>}</li>
 * </ul>
 *
 * @generated
 */
@XmlRootElement(name = "varlist")
@XmlSeeAlso({ VarListProxy.class, Wrapper.class, ElmDeclarationImpl.class, ListOfIDsImpl.class })
public class VarListImpl extends RelationImpl implements VarList {
	...
	public void setOperator(String newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HlvlPackage.VAR_LIST__OPERATOR, oldOperator,
					operator));
	}
	...
	public ElmDeclaration getVar1() {
		if (var1 != null && var1.eIsProxy()) {
			...
			if (var1 != oldVar1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HlvlPackage.VAR_LIST__VAR1, oldVar1,
							var1));
			}
		}
		return var1;
	...
	public NotificationChain basicSetList(ListOfIDs newList, NotificationChain msgs) {
		...
		list = newList;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HlvlPackage.VAR_LIST__LIST,
					oldList, newList);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newList != list) {
			...
			if (list != null)
				msgs = ((InternalEObject) list).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - HlvlPackage.VAR_LIST__LIST, null, msgs);
			if (newList != null)
