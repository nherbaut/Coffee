...
public class RangeResource {
	...
	public RangeResource(Range instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateRange(RangeImpl range) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), range);
	}
