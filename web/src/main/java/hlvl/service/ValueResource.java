...
public class ValueResource {
	...
	public ValueResource(Value instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateValue(ValueImpl value) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), value);
	}
