...
public class RelationalResource {

	private Relational instance;
	private String id;
	private ResourceSaver resourceSaver;

	public RelationalResource(Relational instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateRelational(RelationalImpl relational) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), relational);
	}
