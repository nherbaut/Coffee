...
public class UnaryResource {
	...
	private Unary instance;
	private String id;
	private ResourceSaver resourceSaver;

	public UnaryResource(Unary instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateUnary(UnaryImpl unary) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), unary);
	}
