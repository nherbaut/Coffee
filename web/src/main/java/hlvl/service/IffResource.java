...
public class IffResource {

	private Iff instance;
	private String id;
	private ResourceSaver resourceSaver;

	public IffResource(Iff instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateIff(IffImpl iff) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), iff);
	}

	@PermitAll
	@DELETE
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void deleteIff() {
