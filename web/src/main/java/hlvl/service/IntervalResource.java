...
public class IntervalResource {
	...
	public IntervalResource(Interval instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateInterval(IntervalImpl interval) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), interval);
	}
