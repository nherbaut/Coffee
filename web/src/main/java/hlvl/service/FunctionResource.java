...
public class FunctionResource {
	...
	public FunctionResource(Function instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateFunction(FunctionImpl function) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), function);
	}
