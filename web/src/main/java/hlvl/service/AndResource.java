...
public class AndResource {

	private And instance;
	private String id;
	private ResourceSaver resourceSaver;

	public AndResource(And instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateAnd(AndImpl and) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), and);
	}
