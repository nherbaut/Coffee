...
public class EqualityResource {
	...
	private Equality instance;
	private String id;
	private ResourceSaver resourceSaver;

	public EqualityResource(Equality instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateEquality(EqualityImpl equality) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), equality);
	}
