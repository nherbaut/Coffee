...
public class DecompositionResource {
	...
	private Decomposition instance;
	private String id;
	private ResourceSaver resourceSaver;

	public DecompositionResource(Decomposition instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateDecomposition(DecompositionImpl decomposition) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), decomposition);
	}
