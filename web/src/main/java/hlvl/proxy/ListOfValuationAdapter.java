...
public class ListOfValuationAdapter extends XmlAdapter<ListOfValuationProxy, ListOfValuation> {
	...
	@Override
	public ListOfValuationProxy marshal(ListOfValuation arg0) throws Exception {

		ListOfValuationProxy d = ProxyFactory.createListOfValuationProxy(arg0.eClass().getName());
	...
	@Override
	public ListOfValuation unmarshal(ListOfValuationProxy arg0) throws Exception {
		return ProxyFactory.createListOfValuation(arg0);
	}

	public String getURL(ListOfValuation obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getListOfValuationId(obj);
		EObject temp = obj;
