...
public class OperationsAdapter extends XmlAdapter<OperationsProxy, Operations> {
	...
	@Override
	public OperationsProxy marshal(Operations arg0) throws Exception {

		OperationsProxy d = ProxyFactory.createOperationsProxy(arg0.eClass().getName());
	...
	@Override
	public Operations unmarshal(OperationsProxy arg0) throws Exception {
		return ProxyFactory.createOperations(arg0);
	}

	public String getURL(Operations obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getOperationsId(obj);
		EObject temp = obj;
