...
public class ValueAdapter extends XmlAdapter<ValueProxy, Value> {
	...
	@Override
	public ValueProxy marshal(Value arg0) throws Exception {

		ValueProxy d = ProxyFactory.createValueProxy(arg0.eClass().getName());
	...
	@Override
	public Value unmarshal(ValueProxy arg0) throws Exception {
		return ProxyFactory.createValue(arg0);
	}

	public String getURL(Value obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getValueId(obj);
		EObject temp = obj;
