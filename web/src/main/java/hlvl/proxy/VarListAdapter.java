...
public class VarListAdapter extends XmlAdapter<VarListProxy, VarList> {
	...
	@Override
	public VarListProxy marshal(VarList arg0) throws Exception {

		VarListProxy d = ProxyFactory.createVarListProxy(arg0.eClass().getName());
	...
	@Override
	public VarList unmarshal(VarListProxy arg0) throws Exception {
		return ProxyFactory.createVarList(arg0);
	}

	public String getURL(VarList obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getVarListId(obj);
		EObject temp = obj;
