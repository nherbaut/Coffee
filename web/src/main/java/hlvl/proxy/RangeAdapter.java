...
public class RangeAdapter extends XmlAdapter<RangeProxy, Range> {
	...
	@Override
	public RangeProxy marshal(Range arg0) throws Exception {

		RangeProxy d = ProxyFactory.createRangeProxy(arg0.eClass().getName());
	...
	@Override
	public Range unmarshal(RangeProxy arg0) throws Exception {
		return ProxyFactory.createRange(arg0);
	}

	public String getURL(Range obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getRangeId(obj);
		EObject temp = obj;
