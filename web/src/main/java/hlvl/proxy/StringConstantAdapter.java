...
public class StringConstantAdapter extends XmlAdapter<StringConstantProxy, StringConstant> {
	...
	@Override
	public StringConstantProxy marshal(StringConstant arg0) throws Exception {

		StringConstantProxy d = ProxyFactory.createStringConstantProxy(arg0.eClass().getName());
	...
	@Override
	public StringConstant unmarshal(StringConstantProxy arg0) throws Exception {
		return ProxyFactory.createStringConstant(arg0);
	}

	public String getURL(StringConstant obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getStringConstantId(obj);
		EObject temp = obj;
