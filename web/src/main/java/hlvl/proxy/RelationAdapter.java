...
public class RelationAdapter extends XmlAdapter<RelationProxy, Relation> {
	...
	@Override
	public RelationProxy marshal(Relation arg0) throws Exception {

		RelationProxy d = ProxyFactory.createRelationProxy(arg0.eClass().getName());
	...
	@Override
	public Relation unmarshal(RelationProxy arg0) throws Exception {
		return ProxyFactory.createRelation(arg0);
	}

	public String getURL(Relation obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getRelationId(obj);
		EObject temp = obj;
