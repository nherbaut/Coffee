...
public class VariableDeclAdapter extends XmlAdapter<VariableDeclProxy, VariableDecl> {
	...
	@Override
	public VariableDeclProxy marshal(VariableDecl arg0) throws Exception {

		VariableDeclProxy d = ProxyFactory.createVariableDeclProxy(arg0.eClass().getName());
	...
	@Override
	public VariableDecl unmarshal(VariableDeclProxy arg0) throws Exception {
		return ProxyFactory.createVariableDecl(arg0);
	}

	public String getURL(VariableDecl obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getVariableDeclId(obj);
		EObject temp = obj;
