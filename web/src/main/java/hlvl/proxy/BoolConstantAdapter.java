...
public class BoolConstantAdapter extends XmlAdapter<BoolConstantProxy, BoolConstant> {
	...
	@Override
	public BoolConstantProxy marshal(BoolConstant arg0) throws Exception {

		BoolConstantProxy d = ProxyFactory.createBoolConstantProxy(arg0.eClass().getName());
	...
	@Override
	public BoolConstant unmarshal(BoolConstantProxy arg0) throws Exception {
		return ProxyFactory.createBoolConstant(arg0);
	}

	public String getURL(BoolConstant obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getBoolConstantId(obj);
		EObject temp = obj;
