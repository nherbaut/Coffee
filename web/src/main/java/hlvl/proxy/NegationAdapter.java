...
public class NegationAdapter extends XmlAdapter<NegationProxy, Negation> {
	...
	@Override
	public NegationProxy marshal(Negation arg0) throws Exception {

		NegationProxy d = ProxyFactory.createNegationProxy(arg0.eClass().getName());
	...
	@Override
	public Negation unmarshal(NegationProxy arg0) throws Exception {
		return ProxyFactory.createNegation(arg0);
	}

	public String getURL(Negation obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getNegationId(obj);
		EObject temp = obj;
