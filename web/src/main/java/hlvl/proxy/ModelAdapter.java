...
public class ModelAdapter extends XmlAdapter<ModelProxy, Model> {
	...
	@Override
	public ModelProxy marshal(Model arg0) throws Exception {

		ModelProxy d = ProxyFactory.createModelProxy(arg0.eClass().getName());
	...
	@Override
	public Model unmarshal(ModelProxy arg0) throws Exception {
		return ProxyFactory.createModel(arg0);
	}

	public String getURL(Model obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getModelId(obj);
		EObject temp = obj;
