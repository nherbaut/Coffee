...
public class MulOrDivAdapter extends XmlAdapter<MulOrDivProxy, MulOrDiv> {
	...
	@Override
	public MulOrDivProxy marshal(MulOrDiv arg0) throws Exception {

		MulOrDivProxy d = ProxyFactory.createMulOrDivProxy(arg0.eClass().getName());
	...
	@Override
	public MulOrDiv unmarshal(MulOrDivProxy arg0) throws Exception {
		return ProxyFactory.createMulOrDiv(arg0);
	}

	public String getURL(MulOrDiv obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getMulOrDivId(obj);
		EObject temp = obj;
