...
public class MinusAdapter extends XmlAdapter<MinusProxy, Minus> {
	...
	@Override
	public MinusProxy marshal(Minus arg0) throws Exception {

		MinusProxy d = ProxyFactory.createMinusProxy(arg0.eClass().getName());
	...
	@Override
	public Minus unmarshal(MinusProxy arg0) throws Exception {
		return ProxyFactory.createMinus(arg0);
	}

	public String getURL(Minus obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getMinusId(obj);
		EObject temp = obj;
