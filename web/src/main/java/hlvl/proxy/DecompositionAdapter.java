...
public class DecompositionAdapter extends XmlAdapter<DecompositionProxy, Decomposition> {
	...
	@Override
	public DecompositionProxy marshal(Decomposition arg0) throws Exception {

		DecompositionProxy d = ProxyFactory.createDecompositionProxy(arg0.eClass().getName());
	...
	@Override
	public Decomposition unmarshal(DecompositionProxy arg0) throws Exception {
		return ProxyFactory.createDecomposition(arg0);
	}

	public String getURL(Decomposition obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getDecompositionId(obj);
		EObject temp = obj;
