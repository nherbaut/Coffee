...
public class IntervalAdapter extends XmlAdapter<IntervalProxy, Interval> {
	...
	@Override
	public IntervalProxy marshal(Interval arg0) throws Exception {

		IntervalProxy d = ProxyFactory.createIntervalProxy(arg0.eClass().getName());
	...
	@Override
	public Interval unmarshal(IntervalProxy arg0) throws Exception {
		return ProxyFactory.createInterval(arg0);
	}

	public String getURL(Interval obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getIntervalId(obj);
		EObject temp = obj;
