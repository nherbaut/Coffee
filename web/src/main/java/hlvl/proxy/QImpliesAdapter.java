...
public class QImpliesAdapter extends XmlAdapter<QImpliesProxy, QImplies> {
	...
	@Override
	public QImpliesProxy marshal(QImplies arg0) throws Exception {

		QImpliesProxy d = ProxyFactory.createQImpliesProxy(arg0.eClass().getName());
	...
	@Override
	public QImplies unmarshal(QImpliesProxy arg0) throws Exception {
		return ProxyFactory.createQImplies(arg0);
	}

	public String getURL(QImplies obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getQImpliesId(obj);
		EObject temp = obj;
