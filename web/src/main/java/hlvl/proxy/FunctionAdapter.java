...
public class FunctionAdapter extends XmlAdapter<FunctionProxy, Function> {
	...
	@Override
	public FunctionProxy marshal(Function arg0) throws Exception {

		FunctionProxy d = ProxyFactory.createFunctionProxy(arg0.eClass().getName());
	...
	@Override
	public Function unmarshal(FunctionProxy arg0) throws Exception {
		return ProxyFactory.createFunction(arg0);
	}

	public String getURL(Function obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getFunctionId(obj);
		EObject temp = obj;
