...
public class DeclarationAdapter extends XmlAdapter<DeclarationProxy, Declaration> {
	...
	@Override
	public DeclarationProxy marshal(Declaration arg0) throws Exception {

		DeclarationProxy d = ProxyFactory.createDeclarationProxy(arg0.eClass().getName());
	...
	@Override
	public Declaration unmarshal(DeclarationProxy arg0) throws Exception {
		return ProxyFactory.createDeclaration(arg0);
	}

	public String getURL(Declaration obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getDeclarationId(obj);
		EObject temp = obj;
