...
public class ListOfValuesAdapter extends XmlAdapter<ListOfValuesProxy, ListOfValues> {
	...
	@Override
	public ListOfValuesProxy marshal(ListOfValues arg0) throws Exception {

		ListOfValuesProxy d = ProxyFactory.createListOfValuesProxy(arg0.eClass().getName());
	...
	@Override
	public ListOfValues unmarshal(ListOfValuesProxy arg0) throws Exception {
		return ProxyFactory.createListOfValues(arg0);
	}

	public String getURL(ListOfValues obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getListOfValuesId(obj);
		EObject temp = obj;
