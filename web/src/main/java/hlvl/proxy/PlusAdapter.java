...
public class PlusAdapter extends XmlAdapter<PlusProxy, Plus> {
	...
	@Override
	public PlusProxy marshal(Plus arg0) throws Exception {

		PlusProxy d = ProxyFactory.createPlusProxy(arg0.eClass().getName());
	...
	@Override
	public Plus unmarshal(PlusProxy arg0) throws Exception {
		return ProxyFactory.createPlus(arg0);
	}

	public String getURL(Plus obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getPlusId(obj);
		EObject temp = obj;
