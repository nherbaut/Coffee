...
public class ElmDeclarationAdapter extends XmlAdapter<ElmDeclarationProxy, ElmDeclaration> {
	...
	@Override
	public ElmDeclarationProxy marshal(ElmDeclaration arg0) throws Exception {

		ElmDeclarationProxy d = ProxyFactory.createElmDeclarationProxy(arg0.eClass().getName());
	...
	@Override
	public ElmDeclaration unmarshal(ElmDeclarationProxy arg0) throws Exception {
		return ProxyFactory.createElmDeclaration(arg0);
	}

	public String getURL(ElmDeclaration obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getElmDeclarationId(obj);
		EObject temp = obj;
