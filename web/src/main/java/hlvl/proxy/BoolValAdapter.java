...
public class BoolValAdapter extends XmlAdapter<BoolValProxy, BoolVal> {
	...
	@Override
	public BoolValProxy marshal(BoolVal arg0) throws Exception {

		BoolValProxy d = ProxyFactory.createBoolValProxy(arg0.eClass().getName());
	...
	@Override
	public BoolVal unmarshal(BoolValProxy arg0) throws Exception {
		return ProxyFactory.createBoolVal(arg0);
	}

	public String getURL(BoolVal obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getBoolValId(obj);
		EObject temp = obj;
