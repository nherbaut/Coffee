...
public class GroupAdapter extends XmlAdapter<GroupProxy, Group> {
	...
	@Override
	public GroupProxy marshal(Group arg0) throws Exception {

		GroupProxy d = ProxyFactory.createGroupProxy(arg0.eClass().getName());
	...
	@Override
	public Group unmarshal(GroupProxy arg0) throws Exception {
		return ProxyFactory.createGroup(arg0);
	}

	public String getURL(Group obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getGroupId(obj);
		EObject temp = obj;
