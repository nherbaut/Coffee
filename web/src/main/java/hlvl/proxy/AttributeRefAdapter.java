...
public class AttributeRefAdapter extends XmlAdapter<AttributeRefProxy, AttributeRef> {
	...
	@Override
	public AttributeRefProxy marshal(AttributeRef arg0) throws Exception {

		AttributeRefProxy d = ProxyFactory.createAttributeRefProxy(arg0.eClass().getName());
	...
	@Override
	public AttributeRef unmarshal(AttributeRefProxy arg0) throws Exception {
		return ProxyFactory.createAttributeRef(arg0);
	}

	public String getURL(AttributeRef obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getAttributeRefId(obj);
		EObject temp = obj;
