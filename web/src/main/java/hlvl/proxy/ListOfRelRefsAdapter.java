...
public class ListOfRelRefsAdapter extends XmlAdapter<ListOfRelRefsProxy, ListOfRelRefs> {
	...
	@Override
	public ListOfRelRefsProxy marshal(ListOfRelRefs arg0) throws Exception {

		ListOfRelRefsProxy d = ProxyFactory.createListOfRelRefsProxy(arg0.eClass().getName());
	...
	@Override
	public ListOfRelRefs unmarshal(ListOfRelRefsProxy arg0) throws Exception {
		return ProxyFactory.createListOfRelRefs(arg0);
	}

	public String getURL(ListOfRelRefs obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getListOfRelRefsId(obj);
		EObject temp = obj;
