...
public class ValidConfAdapter extends XmlAdapter<ValidConfProxy, ValidConf> {
	...
	@Override
	public ValidConfProxy marshal(ValidConf arg0) throws Exception {

		ValidConfProxy d = ProxyFactory.createValidConfProxy(arg0.eClass().getName());
	...
	@Override
	public ValidConf unmarshal(ValidConfProxy arg0) throws Exception {
		return ProxyFactory.createValidConf(arg0);
	}

	public String getURL(ValidConf obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getValidConfId(obj);
		EObject temp = obj;
