...
public class ListOfListValuesAdapter extends XmlAdapter<ListOfListValuesProxy, ListOfListValues> {
	...
	@Override
	public ListOfListValuesProxy marshal(ListOfListValues arg0) throws Exception {

		ListOfListValuesProxy d = ProxyFactory.createListOfListValuesProxy(arg0.eClass().getName());
	...
	@Override
	public ListOfListValues unmarshal(ListOfListValuesProxy arg0) throws Exception {
		return ProxyFactory.createListOfListValues(arg0);
	}

	public String getURL(ListOfListValues obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getListOfListValuesId(obj);
		EObject temp = obj;
