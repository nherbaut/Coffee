...
public class EnumerationAdapter extends XmlAdapter<EnumerationProxy, Enumeration> {
	...
	@Override
	public EnumerationProxy marshal(Enumeration arg0) throws Exception {

		EnumerationProxy d = ProxyFactory.createEnumerationProxy(arg0.eClass().getName());
	...
	@Override
	public Enumeration unmarshal(EnumerationProxy arg0) throws Exception {
		return ProxyFactory.createEnumeration(arg0);
	}

	public String getURL(Enumeration obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getEnumerationId(obj);
		EObject temp = obj;
