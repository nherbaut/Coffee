...
public class RelationalAdapter extends XmlAdapter<RelationalProxy, Relational> {
	...
	@Override
	public RelationalProxy marshal(Relational arg0) throws Exception {

		RelationalProxy d = ProxyFactory.createRelationalProxy(arg0.eClass().getName());
	...
	@Override
	public Relational unmarshal(RelationalProxy arg0) throws Exception {
		return ProxyFactory.createRelational(arg0);
	}

	public String getURL(Relational obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getRelationalId(obj);
		EObject temp = obj;
