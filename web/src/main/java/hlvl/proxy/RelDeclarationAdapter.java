...
public class RelDeclarationAdapter extends XmlAdapter<RelDeclarationProxy, RelDeclaration> {
	...
	@Override
	public RelDeclarationProxy marshal(RelDeclaration arg0) throws Exception {

		RelDeclarationProxy d = ProxyFactory.createRelDeclarationProxy(arg0.eClass().getName());
	...
	@Override
	public RelDeclaration unmarshal(RelDeclarationProxy arg0) throws Exception {
		return ProxyFactory.createRelDeclaration(arg0);
	}

	public String getURL(RelDeclaration obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getRelDeclarationId(obj);
		EObject temp = obj;
