...
public class IntConstantAdapter extends XmlAdapter<IntConstantProxy, IntConstant> {
	...
	@Override
	public IntConstantProxy marshal(IntConstant arg0) throws Exception {

		IntConstantProxy d = ProxyFactory.createIntConstantProxy(arg0.eClass().getName());
	...
	@Override
	public IntConstant unmarshal(IntConstantProxy arg0) throws Exception {
		return ProxyFactory.createIntConstant(arg0);
	}

	public String getURL(IntConstant obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getIntConstantId(obj);
		EObject temp = obj;
