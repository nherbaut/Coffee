...
public class HierarchyAdapter extends XmlAdapter<HierarchyProxy, Hierarchy> {
	...
	@Override
	public HierarchyProxy marshal(Hierarchy arg0) throws Exception {

		HierarchyProxy d = ProxyFactory.createHierarchyProxy(arg0.eClass().getName());
	...
	@Override
	public Hierarchy unmarshal(HierarchyProxy arg0) throws Exception {
		return ProxyFactory.createHierarchy(arg0);
	}

	public String getURL(Hierarchy obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getHierarchyId(obj);
		EObject temp = obj;
