...
public class PairAdapter extends XmlAdapter<PairProxy, Pair> {
	...
	@Override
	public PairProxy marshal(Pair arg0) throws Exception {

		PairProxy d = ProxyFactory.createPairProxy(arg0.eClass().getName());
	...
	@Override
	public Pair unmarshal(PairProxy arg0) throws Exception {
		return ProxyFactory.createPair(arg0);
	}

	public String getURL(Pair obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getPairId(obj);
		EObject temp = obj;
