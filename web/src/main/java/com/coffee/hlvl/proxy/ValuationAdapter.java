...
public class ValuationAdapter extends XmlAdapter<ValuationProxy, Valuation> {
	...
	@Override
	public ValuationProxy marshal(Valuation arg0) throws Exception {

		ValuationProxy d = ProxyFactory.createValuationProxy(arg0.eClass().getName());
	...
	@Override
	public Valuation unmarshal(ValuationProxy arg0) throws Exception {
		return ProxyFactory.createValuation(arg0);
	}

	public String getURL(Valuation obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getValuationId(obj);
		EObject temp = obj;
