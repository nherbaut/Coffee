...
public class UnaryAdapter extends XmlAdapter<UnaryProxy, Unary> {
	...
	@Override
	public UnaryProxy marshal(Unary arg0) throws Exception {

		UnaryProxy d = ProxyFactory.createUnaryProxy(arg0.eClass().getName());
	...
	@Override
	public Unary unmarshal(UnaryProxy arg0) throws Exception {
		return ProxyFactory.createUnary(arg0);
	}

	public String getURL(Unary obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getUnaryId(obj);
		EObject temp = obj;
