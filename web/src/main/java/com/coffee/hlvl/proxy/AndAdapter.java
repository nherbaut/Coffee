...
public class AndAdapter extends XmlAdapter<AndProxy, And> {
	...
	@Override
	public AndProxy marshal(And arg0) throws Exception {

		AndProxy d = ProxyFactory.createAndProxy(arg0.eClass().getName());
	...
	@Override
	public And unmarshal(AndProxy arg0) throws Exception {
		return ProxyFactory.createAnd(arg0);
	}

	public String getURL(And obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getAndId(obj);
		EObject temp = obj;
