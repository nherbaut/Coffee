...
public class SymbolAdapter extends XmlAdapter<SymbolProxy, Symbol> {
	...
	@Override
	public SymbolProxy marshal(Symbol arg0) throws Exception {

		SymbolProxy d = ProxyFactory.createSymbolProxy(arg0.eClass().getName());
	...
	@Override
	public Symbol unmarshal(SymbolProxy arg0) throws Exception {
		return ProxyFactory.createSymbol(arg0);
	}

	public String getURL(Symbol obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getSymbolId(obj);
		EObject temp = obj;
