...
public class ConstantDeclAdapter extends XmlAdapter<ConstantDeclProxy, ConstantDecl> {
	...
	@Override
	public ConstantDeclProxy marshal(ConstantDecl arg0) throws Exception {

		ConstantDeclProxy d = ProxyFactory.createConstantDeclProxy(arg0.eClass().getName());
	...
	@Override
	public ConstantDecl unmarshal(ConstantDeclProxy arg0) throws Exception {
		return ProxyFactory.createConstantDecl(arg0);
	}

	public String getURL(ConstantDecl obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getConstantDeclId(obj);
		EObject temp = obj;
