...
public class SingleInstructionAdapter extends XmlAdapter<SingleInstructionProxy, SingleInstruction> {
	...
	@Override
	public SingleInstructionProxy marshal(SingleInstruction arg0) throws Exception {

		SingleInstructionProxy d = ProxyFactory.createSingleInstructionProxy(arg0.eClass().getName());
	...
	@Override
	public SingleInstruction unmarshal(SingleInstructionProxy arg0) throws Exception {
		return ProxyFactory.createSingleInstruction(arg0);
	}

	public String getURL(SingleInstruction obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getSingleInstructionId(obj);
		EObject temp = obj;
