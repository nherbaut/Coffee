...
public class NumberAdapter extends XmlAdapter<NumberProxy, com.coffee.hlvl.Number> {
	...
	@Override
	public NumberProxy marshal(Number arg0) throws Exception {

		NumberProxy d = ProxyFactory.createNumberProxy(arg0.eClass().getName());
	...
	@Override
	public Number unmarshal(NumberProxy arg0) throws Exception {
		return ProxyFactory.createNumber(arg0);
	}

	public String getURL(Number obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getNumberId(obj);
		EObject temp = obj;
