...
public class VariableRefAdapter extends XmlAdapter<VariableRefProxy, VariableRef> {
	...
	@Override
	public VariableRefProxy marshal(VariableRef arg0) throws Exception {

		VariableRefProxy d = ProxyFactory.createVariableRefProxy(arg0.eClass().getName());
	...
	@Override
	public VariableRef unmarshal(VariableRefProxy arg0) throws Exception {
		return ProxyFactory.createVariableRef(arg0);
	}

	public String getURL(VariableRef obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getVariableRefId(obj);
		EObject temp = obj;
