...
public class ImpliesAdapter extends XmlAdapter<ImpliesProxy, Implies> {
	...
	@Override
	public ImpliesProxy marshal(Implies arg0) throws Exception {

		ImpliesProxy d = ProxyFactory.createImpliesProxy(arg0.eClass().getName());
	...
	@Override
	public Implies unmarshal(ImpliesProxy arg0) throws Exception {
		return ProxyFactory.createImplies(arg0);
	}

	public String getURL(Implies obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getImpliesId(obj);
		EObject temp = obj;
