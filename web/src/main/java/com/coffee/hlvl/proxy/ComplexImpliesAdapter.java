...
public class ComplexImpliesAdapter extends XmlAdapter<ComplexImpliesProxy, ComplexImplies> {
	...
	@Override
	public ComplexImpliesProxy marshal(ComplexImplies arg0) throws Exception {

		ComplexImpliesProxy d = ProxyFactory.createComplexImpliesProxy(arg0.eClass().getName());
	...
	@Override
	public ComplexImplies unmarshal(ComplexImpliesProxy arg0) throws Exception {
		return ProxyFactory.createComplexImplies(arg0);
	}

	public String getURL(ComplexImplies obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getComplexImpliesId(obj);
		EObject temp = obj;
