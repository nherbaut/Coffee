...
public class ListOfIDsAdapter extends XmlAdapter<ListOfIDsProxy, ListOfIDs> {
	...
	@Override
	public ListOfIDsProxy marshal(ListOfIDs arg0) throws Exception {

		ListOfIDsProxy d = ProxyFactory.createListOfIDsProxy(arg0.eClass().getName());
	...
	@Override
	public ListOfIDs unmarshal(ListOfIDsProxy arg0) throws Exception {
		return ProxyFactory.createListOfIDs(arg0);
	}

	public String getURL(ListOfIDs obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getListOfIDsId(obj);
		EObject temp = obj;
