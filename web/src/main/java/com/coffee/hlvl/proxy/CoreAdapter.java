...
public class CoreAdapter extends XmlAdapter<CoreProxy, Core> {
	...
	@Override
	public CoreProxy marshal(Core arg0) throws Exception {

		CoreProxy d = ProxyFactory.createCoreProxy(arg0.eClass().getName());
	...
	@Override
	public Core unmarshal(CoreProxy arg0) throws Exception {
		return ProxyFactory.createCore(arg0);
	}

	public String getURL(Core obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getCoreId(obj);
		EObject temp = obj;
