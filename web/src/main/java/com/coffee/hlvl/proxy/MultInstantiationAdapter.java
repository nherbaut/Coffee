...
public class MultInstantiationAdapter extends XmlAdapter<MultInstantiationProxy, MultInstantiation> {
	...
	@Override
	public MultInstantiationProxy marshal(MultInstantiation arg0) throws Exception {

		MultInstantiationProxy d = ProxyFactory.createMultInstantiationProxy(arg0.eClass().getName());
	...
	@Override
	public MultInstantiation unmarshal(MultInstantiationProxy arg0) throws Exception {
		return ProxyFactory.createMultInstantiation(arg0);
	}

	public String getURL(MultInstantiation obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getMultInstantiationId(obj);
		EObject temp = obj;
