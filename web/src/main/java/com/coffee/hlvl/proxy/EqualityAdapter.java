...
public class EqualityAdapter extends XmlAdapter<EqualityProxy, Equality> {
	...
	@Override
	public EqualityProxy marshal(Equality arg0) throws Exception {

		EqualityProxy d = ProxyFactory.createEqualityProxy(arg0.eClass().getName());
	...
	@Override
	public Equality unmarshal(EqualityProxy arg0) throws Exception {
		return ProxyFactory.createEquality(arg0);
	}

	public String getURL(Equality obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getEqualityId(obj);
		EObject temp = obj;
