...
public class ExpressionAdapter extends XmlAdapter<ExpressionProxy, Expression> {
	...
	@Override
	public ExpressionProxy marshal(Expression arg0) throws Exception {

		ExpressionProxy d = ProxyFactory.createExpressionProxy(arg0.eClass().getName());
	...
	@Override
	public Expression unmarshal(ExpressionProxy arg0) throws Exception {
		return ProxyFactory.createExpression(arg0);
	}

	public String getURL(Expression obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getExpressionId(obj);
		EObject temp = obj;
