...
public class OrderAdapter extends XmlAdapter<OrderProxy, Order> {
	...
	@Override
	public OrderProxy marshal(Order arg0) throws Exception {

		OrderProxy d = ProxyFactory.createOrderProxy(arg0.eClass().getName());
	...
	@Override
	public Order unmarshal(OrderProxy arg0) throws Exception {
		return ProxyFactory.createOrder(arg0);
	}

	public String getURL(Order obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getOrderId(obj);
		EObject temp = obj;
