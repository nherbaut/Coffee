...
public class IffAdapter extends XmlAdapter<IffProxy, Iff> {
	...
	@Override
	public IffProxy marshal(Iff arg0) throws Exception {

		IffProxy d = ProxyFactory.createIffProxy(arg0.eClass().getName());
	...
	@Override
	public Iff unmarshal(IffProxy arg0) throws Exception {
		return ProxyFactory.createIff(arg0);
	}

	public String getURL(Iff obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getIffId(obj);
		EObject temp = obj;
