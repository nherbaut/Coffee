...
public class OptionsDeclarationAdapter extends XmlAdapter<OptionsDeclarationProxy, OptionsDeclaration> {
	...
	@Override
	public OptionsDeclarationProxy marshal(OptionsDeclaration arg0) throws Exception {

		OptionsDeclarationProxy d = ProxyFactory.createOptionsDeclarationProxy(arg0.eClass().getName());
	...
	@Override
	public OptionsDeclaration unmarshal(OptionsDeclarationProxy arg0) throws Exception {
		return ProxyFactory.createOptionsDeclaration(arg0);
	}

	public String getURL(OptionsDeclaration obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getOptionsDeclarationId(obj);
		EObject temp = obj;
