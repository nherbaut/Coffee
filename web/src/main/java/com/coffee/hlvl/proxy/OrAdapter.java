...
public class OrAdapter extends XmlAdapter<OrProxy, Or> {
	...
	@Override
	public OrProxy marshal(Or arg0) throws Exception {

		OrProxy d = ProxyFactory.createOrProxy(arg0.eClass().getName());
	...
	@Override
	public Or unmarshal(OrProxy arg0) throws Exception {
		return ProxyFactory.createOr(arg0);
	}

	public String getURL(Or obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getOrId(obj);
		EObject temp = obj;
