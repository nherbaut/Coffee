...
public class RelationResource {
	...
	public RelationResource(Relation instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateRelation(RelationImpl relation) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), relation);
	}
