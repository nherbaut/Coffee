...
public class BoolConstantResource {

	private BoolConstant instance;
	private String id;
	private ResourceSaver resourceSaver;

	public BoolConstantResource(BoolConstant instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateBoolConstant(BoolConstantImpl boolConstant) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), boolConstant);
	}

	@PermitAll
	@DELETE
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void deleteBoolConstant() {
