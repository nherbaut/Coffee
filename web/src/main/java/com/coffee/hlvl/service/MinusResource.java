...
public class MinusResource {

	private Minus instance;
	private String id;
	private ResourceSaver resourceSaver;

	public MinusResource(Minus instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateMinus(MinusImpl minus) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), minus);
	}
