...
public class QImpliesResource {

	private QImplies instance;
	private String id;
	private ResourceSaver resourceSaver;

	public QImpliesResource(QImplies instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateQImplies(QImpliesImpl qImplies) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), qImplies);
	}

	@PermitAll
	@DELETE
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void deleteQImplies() {
