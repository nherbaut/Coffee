...
public class StringConstantResource {
	...
	private StringConstant instance;
	private String id;
	private ResourceSaver resourceSaver;

	public StringConstantResource(StringConstant instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateStringConstant(StringConstantImpl stringConstant) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), stringConstant);
	}

	@PermitAll
	@DELETE
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void deleteStringConstant() {
