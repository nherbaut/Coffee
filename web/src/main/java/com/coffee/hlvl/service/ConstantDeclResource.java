...
public class ConstantDeclResource {

	private ConstantDecl instance;
	private String id;
	private ResourceSaver resourceSaver;

	public ConstantDeclResource(ConstantDecl instance, String id, ResourceSaver r) {
	...
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void updateConstantDecl(ConstantDeclImpl constantDecl) {
		resourceSaver.put(EcoreUtil.getIdentification(instance), constantDecl);
	}

	@PermitAll
	@DELETE
	@Mapped(namespaceMap = { @XmlNsMap(namespace = "http://emf-rest.com/proxy", jsonName = "proxy") })
	public void deleteConstantDecl() {
