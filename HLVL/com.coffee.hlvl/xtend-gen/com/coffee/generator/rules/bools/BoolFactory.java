...
public class BoolFactory extends TransformationRules implements IConstants {
  ...
  public CharSequence getCore(final /* Core */Object core) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method getCoreSingle(ElmDeclaration) from the type BoolFactory refers to the missing type ElmDeclaration"
  ...
  public CharSequence getGroup(final /* Group */Object rel, final /* Map<String, ElmDeclaration> */Object parents) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method getXor(Group, Map<String, ElmDeclaration>) from the type BoolFactory refers to the missing type Group"
      + "\nThe method getOR(Group, Map<String, ElmDeclaration>) from the type BoolFactory refers to the missing type Group"
  ...
  public CharSequence getImpliesList(final /* VarList */Object rel) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method getImpliesPair(ElmDeclaration, ElmDeclaration) from the type BoolFactory refers to the missing type ElmDeclaration"
  ...
  public CharSequence getMutexList(final /* VarList */Object rel) {
    throw new Error("Unresolved compilation problems:"
      + "\nThe method getMutexPair(ElmDeclaration, ElmDeclaration) from the type BoolFactory refers to the missing type ElmDeclaration"
      + "\nlist cannot be resolved"
      + "\nvalues cannot be resolved"
      + "\nvar1 cannot be resolved");
  }
